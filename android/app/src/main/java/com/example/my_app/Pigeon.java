...
public class Pigeon {
  ...
  public interface Api2Host {
    void ping(@NonNull String message, Result<String> result);
    void startService(Result<Void> result);
    ...
    static void setup(BinaryMessenger binaryMessenger, Api2Host api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.Api2Host.ping", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.ping(messageArg, resultCallback);
            }
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.Api2Host.startService", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ArrayList wrapped = new ArrayList<>();
            try {
              ...
              api.startService(resultCallback);
            }
            catch (Error | RuntimeException exception) {
              ArrayList<Object> wrappedError = wrapError(exception);
              reply.reply(wrappedError);
